...
/**
 * The playground page: example controls + the living example with its
 * PrimeNG-style source tabs. Page concerns live here — the app shell owns
 * only navigation and theme.
 */
@Component({
