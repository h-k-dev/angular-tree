...
- Name: dialog-matrix.spec.ts >> tree inside MatDialog >> focus trap and roving tabindex coexist — arrow keys move row focus
- Location: e2e/dialog-matrix.spec.ts:24:7
