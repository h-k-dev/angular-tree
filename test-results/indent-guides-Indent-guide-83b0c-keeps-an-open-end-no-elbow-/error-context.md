...
- Name: indent-guides.spec.ts >> Indent guides under virtualization >> a group cut by the render window keeps an open end (no elbow)
- Location: e2e/indent-guides.spec.ts:184:7
