...
- Name: inline-rename.spec.ts >> inline rename via the context menu >> Rename keeps the edit input focused; Enter commits the typed name
- Location: e2e/inline-rename.spec.ts:20:7
