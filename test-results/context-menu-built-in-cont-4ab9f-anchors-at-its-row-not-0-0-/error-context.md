...
- Name: context-menu.spec.ts >> built-in context menu >> openContextMenu(node) on a scrolled-away node anchors at its row, not (0,0)
- Location: e2e/context-menu.spec.ts:89:7
