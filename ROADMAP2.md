...
Status: #1 and #2 shipped 2026-07-12 (incl. the same-day `SelectionModel` removal and the `expandedKeys()` method removal; All-In-1 demo migrated to both bindings); 3–6 pending.
