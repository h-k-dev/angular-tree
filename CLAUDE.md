...
- **Current phase: Phase 8 — Hardening & Release, matrix complete** (browser integration matrix + 100k perf benchmark executed 2026-07-07 as a Playwright e2e suite — five real library bugs found and fixed since: four focus/menu 2026-07-07, one zoneless load-state repaint 2026-07-10; README + publish metadata done; demo restructured 2026-07-10 into feature-tour roots incl. a drag & drop rules showcase and a flaky-retry root). Remaining before release: real-AT screen-reader pass, version bump + `npm publish` (user-side). 156 green specs: 127 lib + 9 app + 20 e2e. See ROADMAP.md.
